...
use crate::handlers::auth::{get_current_user, get_session_token, login, logout, register};
use crate::handlers::room::{create_room, get_rooms, join_room, get_room_members, update_room, delete_room};
...
pub fn create_router(
    ...
    Router::new()
        ...
        .route(
            ...
            post(logout).layer(auth_layer.clone()),
                ...
                .route(
                    ...
                    get(get_session_token).layer(auth_layer.clone()),
                )
        ...
        .route(
            "/api/rooms/{room_id}",
            put(update_room).delete(delete_room).layer(auth_layer.clone()),
        )
